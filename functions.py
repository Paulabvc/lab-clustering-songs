...
def cluster_song(df):
	...
	# Load scaler
	with open('Documents/Week_6/Day_3/Afternoon/project/lab-clustering-songs/scalers/standard.pickle', 'rb') as file:
		scaler = pickle.load(file)

	# Load clustering model
	with open('Documents/Week_6/Day_3/Afternoon/project/lab-clustering-songs/models/aggl12.pickle', 'rb') as file:
